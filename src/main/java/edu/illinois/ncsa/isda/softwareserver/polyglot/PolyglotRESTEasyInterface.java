...
@Path("/")
public interface PolyglotRESTEasyInterface
{
	@GET
	...
	@Consumes("text/html,text/plain")
	@Produces("text/plain")
	public Response ConvertFile(@Context UriInfo uriInfo, @HeaderParam("Accept") String accept,
			@Context HttpServletRequest req, @PathParam("outFmt") String outFmt, @PathParam("file") String file)
			throws IOException;
	...
	@Consumes("text/html,text/plain")
	@Produces("text/html,text/plain")
	public Response Forms(@Context UriInfo uriInfo, @DefaultValue("") @QueryParam("output") String output,
	...
	public Response formPost(MultipartFormDataInput input, @HeaderParam("Content-Type") String mediaType,
			@HeaderParam("Accept") String accept, @Context UriInfo uri, @Context HttpServletRequest req,
