...
@Path("/")
public interface ResteasyResourcesInterface {
  ...
  @Consumes("text/html,text/plain")
  @Produces("text/html,text/plain")
  public Response listOutputFmts(@Context UriInfo uriInfo,@HeaderParam("Accept") String produces,@PathParam("app") String app, @PathParam("tsk") String tsk);
  ...
  @Consumes("text/html,text/plain")
  @Produces("text/html,text/plain")
  public Response listInputFormats(@Context UriInfo uriInfo, @HeaderParam("Accept") String produces,@PathParam("app") String app, @PathParam("tsk") String tsk);
  ...
  public Response listOutputFile(@Context UriInfo uriInfo, @HeaderParam("Accept") String produces,
  		                           ...
  		                           @PathParam("fmt")  String fmt,@PathParam("file") String file);
  ...
  @Consumes("text/html,text/plain")
  @Produces("text/html")
  public Response processGet(@Context UriInfo uri,
                             @DefaultValue("") @QueryParam("application") String app,
                             @DefaultValue("") @QueryParam("task") 				String tsk,
                             @DefaultValue("") @QueryParam("format") 			String fmt,
...
//+++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  public Response taskPost(MultipartFormDataInput input, 
  												...
  												@PathParam("tsk")			 String tsk,
  												@PathParam("fmt") 		     String fmt);
